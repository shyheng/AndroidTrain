...
import com.shy.smartcity.Adapter.MoveAdapter;
...
public class MoveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = findViewById(R.id.hos_mo_but);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MoveActivity.this, IndexActivity.class);
                startActivity(intent);
            }
        });

        viewPager = findViewById(R.id.move_vp);
        ...
        for (int i = 0; i < 10; i++) {
           moves.add( new Move(R.drawable.move,"拉斯维加斯","34人","65赞"));
           moves.add( new Move(R.drawable.syr,"成功人士","39人","120赞"));
        }

        RecyclerView recyclerView = findViewById(R.id.move_rv);
        recyclerView.setLayoutManager(new GridLayoutManager(this,1));
        MoveAdapter moveAdapter = new MoveAdapter(moves,this);
        recyclerView.setAdapter(moveAdapter);
        moveAdapter.setOnRecyclerItemClick(new ServerAdapter.OnRecyclerItemClick() {
            @Override
            public void OnRecyclerItemClick(int position) {
                Intent intent = new Intent(MoveActivity.this,MoveItemActivity.class);
                intent.putExtra("name",moves.get(position).getName());
                startActivity(intent);
            }
        });
    }
